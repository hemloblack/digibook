...
<div class="form-container">
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="نام کتاب را وارد کنید" required>
        </div>
        <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" step="1000" placeholder="مثلاً ۵۰۰۰۰۰" required>
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description" rows="4" placeholder="توضیح مختصری درباره کتاب..."></textarea>
        </div>
        <div class="mb-3">
